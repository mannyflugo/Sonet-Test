...
export const Header: React.FC<HeaderProps> = ({ onClear, messageCount }) => {
  return (
    <header className="px-6 py-4 bg-white border-b border-gray-100 flex items-center justify-between sticky top-0 z-10">
      ...
      {messageCount > 0 && (
        <button
          onClick={onClear}
          className="text-xs font-semibold text-gray-500 hover:text-red-500 transition-colors px-3 py-1.5 rounded hover:bg-red-50 flex items-center gap-1"
        >
